...
namespace Engine
{
    namespace Scripting
    {
		...
		namespace AST
		{
			...
			// Node containing a do loop declaration.
			class CScriptDoASTNode : public CScriptASTNode
			{
				private:

				public:
					CScriptDoASTNode								(Engine::Scripting::CScriptToken token, CScriptASTNode* parent);
					~CScriptDoASTNode								();
