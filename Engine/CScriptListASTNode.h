...
namespace Engine
{
    namespace Scripting
    {
		...
		namespace AST
		{
			...
			// Node containing a literal list declaration.
			class CScriptListASTNode : public CScriptASTNode
			{
				private:

				public:
					CScriptListASTNode								(Engine::Scripting::CScriptToken token, CScriptASTNode* parent);
					~CScriptListASTNode								();
